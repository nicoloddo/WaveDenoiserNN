...
from data.noise import get_noise_folds
...
def main(args):
    ...
    args.checkpoint_dir = 'checkpoints/' + args.model_name
    ...
    ### DATASET
    musdb = get_noise_folds(args.dataset_dir)
    # If not data1 augmentation, at least crop targets to fit model output shape
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default="waveunet",
                        help='Dataset path')
    parser.add_argument('--num_workers', type=int, default=1,
                        help='Number of data1 loader worker threads (default: 1)')
    parser.add_argument('--features', type=int, default=32,
                        help='Number of feature channels per layer')
    parser.add_argument('--log_dir', type=str, default='logs/waveunet',
                        help='Folder to write logs into')
    parser.add_argument('--dataset_dir', type=str, default="/WaveUNet/dataset/train_data",
                        help='Dataset path')
    ...
    parser.add_argument('--test', action='store_true',
                        help='Use only test for loaded model (default: False)')
